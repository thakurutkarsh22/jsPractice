...
let fun1 = function helloFunction() {
  console.log("hello abc")
}

let fun2 = function () {
    console.log("hello anynomoys ")
}
...
let variable1 = abc(); // 1 2 3 [] // promise<any>
...
let arr = ["utkarsh", "ayushi", "rohan", "romit"]

function sortFunction(params) {
  //logic
}
